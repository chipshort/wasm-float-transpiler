...
// TODO: port this whole thing to walrus instead of wasmer
// TODO: write testing code that first runs the wasm through wasmer,
//  then runs it through our transpiler and wasmer, then compares the results
